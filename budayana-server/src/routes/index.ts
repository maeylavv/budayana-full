...
import { quizAttemptRoutes } from "./quiz-attempts"
import { quizStatisticsRoutes } from "./quiz-statistics"
...
export const apiRoutes = new Elysia({ prefix: "/api" })
  ...
  // Quiz Budaya routes
  .use(quizAttemptRoutes)
  .use(quizStatisticsRoutes)
