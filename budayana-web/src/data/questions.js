/**
 * Static question data for pre-test and post-test
 * Questions are the same for both test types per island
 */
...
/**
 * Get questions for an island
 * @param {string} islandSlug
 * @returns {array}
 */
export const getQuestionsByIsland = (islandSlug) => {
  return questions[islandSlug] || []
}
